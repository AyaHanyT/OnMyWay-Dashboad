...
v+w-oa);this.quadraticCurveTo(h+s,v+w,h+s-oa,v+w);this.lineTo(h+oa,v+w);this.quadraticCurveTo(h,v+w,h,v+w-oa);this.lineTo(h,v+oa);this.quadraticCurveTo(h,v,h+oa,v);this.closePath();y&&this.fill();E&&0<x&&this.stroke()}}function Pa(h,m){return h-m}function Q(h){var m=((h&16711680)>>16).toString(16),v=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;v=2>v.length?"0"+v:v;h=2>h.length?"0"+h:h;return"#"+m+v+h}function db(h,m){var v=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Ba(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(M.fSDec)h[ha("`eeDwdouMhrudods")](ha("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){M._fTWm&&M._fTWm(h)})}function Wa(h,m,v){v=v||"normal";var s=h+"_"+m+"_"+v,w=Xa[s];if(isNaN(w)){try{if(!ua){var oa=document.body;ua=document.createElement("span");ua.innerHTML="";var x=document.createTextNode("Mpgyi");ua.appendChild(x);
oa.appendChild(ua)}ua.style.display="";U(ua,{position:"relative",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:v});w=Math.round(ua.offsetHeight);ua.style.display="none"}catch(y){w=Math.ceil(1.1*m)}w=Math.max(w,m);Xa[s]=w}return w}function N(h,m){var v=[];if(v={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<v.length;s++)v[s]*=m;else v=[];return v}function F(h,m,v,w,sa){w=w||[];sa=s(sa)?fb?{passive:!1,capture:!1}:!1:sa;w.push([h,m,v,sa]);return h.addEventListener?(h.addEventListener(m,v,sa),v):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};v.call(h,m)},h.attachEvent("on"+m,w),w):!1}function gb(h){if(h._menuButton)h.exportEnabled?
...
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),F(v,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),F(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Ya(h,m,v){h*=ja;m*=ja;h=v.getImageData(h,m,2,2).data;m=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|h[v]!==h[v+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function ka(h,m,v){return h in m?m[h]:v[h]}function Ka(h,m,v){if(w&&Za){var s=h.getContext("2d");La=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ja=Qa/La;h.width=m*ja;h.height=v*ja;Qa!==La&&(h.style.width=m+"px",h.style.height=v+"px",s.scale(ja,ja))}else h.width=m,h.height=v}function hb(h){if(!ib){var m=!1,v=!1;"undefined"===typeof na.Chart.creditHref?(h.creditHref=ha("iuuqr;..b`ow`rkr/bnl."),
h.creditText=ha("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),v=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),U(h._creditLink,{outline:"none",margin:"0px",position:"relative",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
...
var v=document.createElement("div");v.setAttribute("class","canvasjs-chart-canvas");Ka(v,h,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(v);return v}function U(h,m){for(var v in m)h.style[v]=m[v]}function pa(h,m,v){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",U(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
v&&(m.setAttribute("state",v),m.setAttribute("type","button"),U(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.innerHTML="<img src='"+jb[v].image+"' alt='"+h._cultureInfo[v+"Text"]+"' />",U(m.childNodes[0],{height:"95%",pointerEvents:"none"}));m.setAttribute("title",h._cultureInfo[v+"Text"])}function Ja(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ra(h,m,v,s,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof v?m:v;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof s&&(h=Math.min(s,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof v?m:v}function T(h,m,v,w,y){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=y;this._eventListeners=[];
h={};this.theme&&s(this.parent)&&s(m)&&s(w)?h=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===w?h=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(w=Math.min(this.parent.themeOptions[m].length-1,w),h=this.parent.themeOptions[m][w]));this.themeOptions=h;this.options=v?v:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ca(h,m,v,s,w){"undefined"===
...
"Title","title",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(s(this.options.margin)&&h.options.subtitles)for(var v=h.options.subtitles,w=0;w<v.length;w++)if((s(v[w].horizontalAlign)&&"center"===this.horizontalAlign||v[w].horizontalAlign===this.horizontalAlign)&&(s(v[w].verticalAlign)&&"top"===this.verticalAlign||v[w].verticalAlign===this.verticalAlign)&&!v[w].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&
...
yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){M.fSDec=function(h){for(var m="",v=0;v<h.length;v++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(v));return m};delete na[M.fSDec("Bi`su")][M.fSDec("bsdehuIsdg")];M.pro={sCH:na[M.fSDec("Bi`su")][M.fSDec("bsdehuIsdg")]};M._fTWm=
function(h){if("undefined"===typeof M.pro.sCH&&!bb)try{var m,v=h[M.fSDec("buy")];v[M.fSDec("udyuC`rdmhod")]=M.fSDec("unq");v[M.fSDec("gnou")]=11+M.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg");m=h.height-11;v[M.fSDec("bmd`sSdbu")](0,m,v[M.fSDec("ld`rtsdUdyu")](M.fSDec("B`ow`rKR!Ush`m")).width,11);v[M.fSDec("ghmmRuxmd")]=h.backgroundColor;v[M.fSDec("ghmmSdbu")](0,m,v[M.fSDec("ld`rtsdUdyu")](M.fSDec("B`ow`rKR!Ush`m")).width,11);v[M.fSDec("ghmmRuxmd")]=M.fSDec("fsdx");v[M.fSDec("ghmmUdyu")](M.fSDec("B`ow`rKR!Ush`m"),
0,m)}catch(s){}}})();var fb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(v){h=!1}return h}(),Xa={},ua=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},wa=function(h){h.width=1;h.height=
...
w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),y=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,x=/[^-+\dA-Z]/g;return function(E,N,O){var L=O?O.days:m,Q=O?O.months:s,F=O?O.shortDays:v,S=O?O.shortMonths:w;O="";var M=!1;E=E&&E.getTime?E:E?new Date(E):new Date;if(isNaN(E))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),M=!0);O=M?"getUTC":"get";var U=E[O+"Date"](),J=E[O+"Day"](),
...
v),h=h.toString()+Array(v+1).join("0"));return String(h)},da=function(h,m,v){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",y=v?v.digitGroupSeparator:",",x="";m=String(m);var x=1,E=v="",N=-1,O=[],L=[],Q=0,F=0,S=0,M=!1,U=0,E=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var J=0;E&&J<E.length;J++)if(m=E[J],"."===m&&0>N)N=J;else{if("%"===m)x*=100;else if("\u2030"===m){x*=1E3;continue}else if(","===m[0]&&"."===
m[m.length-1]){x/=Math.pow(1E3,m.length-1);N=J+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(M=!0);0>N?(O.push(m),"#"===m||"0"===m?Q++:","===m&&S++):(L.push(m),"#"!==m&&"0"!==m||F++)}M&&(m=Math.floor(h),E=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===m?-(Q+E):mb(m).length-Q,x/=Math.pow(10,U));0>N&&(N=J);x=(h*x).toFixed(F);m=x.split(".");x=(m[0]+"").split("");h=(m[1]+"").split("");x&&"0"===x[0]&&x.shift();for(M=E=J=F=N=0;0<O.length;)if(m=O.pop(),"#"===m||"0"===m)if(N++,
N===Q){var $=x,x=[];if("0"===m)for(m=Q-F-($?$.length:0);0<m;)$.unshift("0"),m--;for(;0<$.length;)v=$.pop()+v,M++,0===M%E&&(J===S&&0<$.length)&&(v=y+v)}else 0<x.length?(v=x.pop()+v,F++,M++):"0"===m&&(v="0"+v,F++,M++),0===M%E&&(J===S&&0<x.length)&&(v=y+v);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(J++,E=M,M=0,0<x.length&&(v=y+v)):v=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+v:m+v:(m=0>U?m.replace("+","").replace("-",
""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return Z(U,a.length)}));y="";for(O=!1;0<L.length;)m=L.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),O=!0):"0"===m&&(y+="0",O=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return Z(U,a.length)}));
v+=(O?w:"")+y;return s?"-"+v:v},Ma=function(h){var m=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,v=h.layerY):(m=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:m,y:v}},Za=!0,Qa=window.devicePixelRatio||1,La=1,ja=Za?Qa/La:1,ea=function(h,m,v,s,w,y,x,E,N,O,Q,L,M){"undefined"===typeof M&&(M=1);x=x||0;E=E||"black";var F=15<s-m&&15<w-v?8:0.35*Math.min(s-m,w-v);h.beginPath();h.moveTo(m,v);h.save();h.fillStyle=y;h.globalAlpha=
M;h.fillRect(m,v,s-m,w-v);h.globalAlpha=1;0<x&&(M=0===x%2?0:0.5,h.beginPath(),h.lineWidth=x,h.strokeStyle=E,h.moveTo(m,v),h.rect(m-M,v-M,s-m+2*M,w-v+2*M),h.stroke());h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+F,v+F),h.lineTo(s-F,v+F),h.lineTo(s,v),h.closePath(),x=h.createLinearGradient((s+m)/2,v+F,(s+m)/2,v),x.addColorStop(0,y),x.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=x,h.fill(),h.restore());!0===O&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+F,w-F),h.lineTo(s-
F,w-F),h.lineTo(s,w),h.closePath(),x=h.createLinearGradient((s+m)/2,w-F,(s+m)/2,w),x.addColorStop(0,y),x.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=x,h.fill(),h.restore());!0===Q&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+F,v+F),h.lineTo(m+F,w-F),h.lineTo(m,w),h.closePath(),x=h.createLinearGradient(m+F,(w+v)/2,m,(w+v)/2),x.addColorStop(0,y),x.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=x,h.fill(),h.restore());!0===L&&(h.save(),h.beginPath(),h.moveTo(s,v),h.lineTo(s-F,
...
T.prototype.setOptions=function(h,m){if(na[this._defaultsKey]){var s=na[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:s[w])}else Fa&&window.console&&console.log("defaults not set")};T.prototype.get=function(h){var m=na[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
...
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-E.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-E.width/2+this.leftPadding;this.ctx.fillText(E.text,w,y);y+=E.height}this.ctx.font=m;h&&this.ctx.restore()}};ia.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
...
if(s<m)w=E+1;else if(s>m)y=E-1;else break}s>m&&1<x.length&&(x=x.substr(0,x.length-1),s=this.ctx.measureText(x).width);m=!0;if(x.length===h.length||" "===h[x.length])m=!1;m&&(h=x.split(" "),1<h.length&&h.pop(),x=h.join(" "),s=this.ctx.measureText(x).width);return{text:x,width:s}};ia.prototype._wrapText=function(){var h=new String(Ea(String(this.text))),m=[],s=this.ctx.font,w=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=w=0;else for(;0<h.length;){var E=this.maxHeight-(this.topPadding+
this.bottomPadding),x=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);x.height=this._lineHeight;m.push(x);var F=y,y=Math.max(y,x.width),w=w+x.height,h=Ea(h.slice(x.text.length,h.length));E&&w>E&&(x=m.pop(),w-=x.height,y=F)}this._wrappedText={lines:m,width:y,height:w};this.width=y+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};ma(Sa,T);ma(xa,T);xa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,y=m.y1,E=0,F=0,x=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,M;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-x*("center"===this.horizontalAlign?2:1)),F=0.5*m.height-this.margin-2,E=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),F=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),F=0.5*m.height-4));var O;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==
...
"canvasjs-chart-container"),this._canvasJSContainer.style.position="relative",this._canvasJSContainer.style.textAlign="left",this._canvasJSContainer.style.cursor="auto",this._canvasJSContainer.style.direction="ltr",w||(this._canvasJSContainer.style.height="0px"),this.container.appendChild(this._canvasJSContainer),this.canvas=ra(a,d),this._preRenderCanvas=ra(a,d),this.canvas.style.position="relative",this.canvas.style.WebkitUserSelect="none",this.canvas.style.MozUserSelect="none",this.canvas.style.msUserSelect=
"none",this.canvas.style.userSelect="none",this.canvas.getContext&&(this._canvasJSContainer.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.ctx.textBaseline="top",Aa(this.ctx),this._preRenderCtx=this._preRenderCanvas.getContext("2d"),this._preRenderCtx.textBaseline="top",Aa(this._preRenderCtx),w?this.plotArea.ctx=this.ctx:(this.plotArea.canvas=ra(a,d),this.plotArea.canvas.style.position="relative",this.plotArea.canvas.setAttribute("class","plotAreaCanvas"),this._canvasJSContainer.appendChild(this.plotArea.canvas),
this.plotArea.ctx=this.plotArea.canvas.getContext("2d")),this.overlaidCanvas=ra(a,d),this.overlaidCanvas.style.position="relative",this.overlaidCanvas.style.webkitTapHighlightColor="transparent",this.overlaidCanvas.style.WebkitUserSelect="none",this.overlaidCanvas.style.MozUserSelect="none",this.overlaidCanvas.style.msUserSelect="none",this.overlaidCanvas.style.userSelect="none",this.overlaidCanvas.getContext&&(this._canvasJSContainer.appendChild(this.overlaidCanvas),this.overlaidCanvasCtx=this.overlaidCanvas.getContext("2d"),
this.overlaidCanvasCtx.textBaseline="top",Aa(this.overlaidCanvasCtx)),this._eventManager=new ga(this),this.windowResizeHandler=F(window,"resize",function(){b._updateSize()&&b.render()},this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),U(this._toolBar,{position:"relative",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},F(this.overlaidCanvas,
...
a[l].x-a[t].x))*(d-1)/2+1;var C=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<C||a[t].x<a[f].x&&0>C?{x:a[t].x+C/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;C=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<C||a[t].x<a[f].x&&0>C?{x:a[t].x-C/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,l,t,C,k){var n=0;k?
(l.color=f,t.color=f):k=1;n=C?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);C?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(N(t.dashType,t.thickness));a.beginPath();C&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):
0<t.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(N(l.dashType,l.thickness));a.beginPath();C&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function E(a,d){E.base.constructor.call(this,"Legend","legend",d,null,
...
this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ca(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new L(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);
...
C=null;t.targetCanvas&&wa(t.targetCanvas);t.targetCanvas=null;this.animatedRender&&(t.targetCanvas=ra(this.width,this.height),t.targetCanvasCtx=t.targetCanvas.getContext("2d"),e=t.targetCanvasCtx.miterLimit,t.targetCanvasCtx.miterLimit=3);"line"===t.type?C=this.renderLine(t):"stepLine"===t.type?C=this.renderStepLine(t):"spline"===t.type?C=this.renderSpline(t):"column"===t.type?C=this.renderColumn(t):"bar"===t.type?C=this.renderBar(t):"area"===t.type?C=this.renderArea(t):"stepArea"===t.type?C=this.renderStepArea(t):
"splineArea"===t.type?C=this.renderSplineArea(t):"stackedColumn"===t.type?C=this.renderStackedColumn(t):"stackedColumn100"===t.type?C=this.renderStackedColumn100(t):"stackedBar"===t.type?C=this.renderStackedBar(t):"stackedBar100"===t.type?C=this.renderStackedBar100(t):"stackedArea"===t.type?C=this.renderStackedArea(t):"stackedArea100"===t.type?C=this.renderStackedArea100(t):"bubble"===t.type?C=C=this.renderBubble(t):"scatter"===t.type?C=this.renderScatter(t):"pie"===t.type?this.renderPie(t):"doughnut"===
t.type?this.renderPie(t):"funnel"===t.type?C=this.renderFunnel(t):"pyramid"===t.type?C=this.renderFunnel(t):"candlestick"===t.type?C=this.renderCandlestick(t):"ohlc"===t.type?C=this.renderCandlestick(t):"rangeColumn"===t.type?C=this.renderRangeColumn(t):"error"===t.type?C=this.renderError(t):"rangeBar"===t.type?C=this.renderRangeBar(t):"rangeArea"===t.type?C=this.renderRangeArea(t):"rangeSplineArea"===t.type?C=this.renderRangeSplineArea(t):"waterfall"===t.type?C=this.renderWaterfall(t):"boxAndWhisker"===
t.type&&(C=this.renderBoxAndWhisker(t));for(var k=0;k<t.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[k]]);this.animatedRender&&(t.targetCanvasCtx.miterLimit=e,C&&c.push(C))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&
...
C=0,k=!1,n=!1,p;if("normal"===t.axisPlacement||"xySwapped"===t.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(t.dataPoints[C].x&&t.dataPoints[C].x.getTime||"dateTime"===t.xValueType)f=!0;for(C=0;C<t.dataPoints.length;C++){"undefined"===typeof t.dataPoints[C].x&&(t.dataPoints[C].x=C+(a.axisX.logarithmic?1:0));t.dataPoints[C].x.getTime?(f=!0,b=t.dataPoints[C].x.getTime()):b=t.dataPoints[C].x;e=t.dataPoints[C].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);e<d.min&&"number"===typeof e&&(d.min=e);
e>d.max&&"number"===typeof e&&(d.max=e);if(0<C){if(a.axisX.logarithmic){var r=b/t.dataPoints[C-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-t.dataPoints[C-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==t.dataPoints[C-1].y&&(a.axisY.logarithmic?(r=e/t.dataPoints[C-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-t.dataPoints[C-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<C)){C-=2;continue}if(b>g&&
!n)n=!0;else if(b>g&&n)continue;t.dataPoints[C].label&&(a.axisX.labels[b]=t.dataPoints[C].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],C=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var nb=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var m=b/p.dataPoints[q-1].x;1>m&&(m=1/m);c.minDiff>m&&1!==m&&(c.minDiff=m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<nb&&
!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,C=Math.min(e,C)):t[b]?t[b]+=e:(t[b]=e,k=Math.max(e,
k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=t));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,C)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||
...
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[p].x&&n.dataPoints[p].x.getTime||"dateTime"===n.xValueType)f=!0;for(p=0;p<n.dataPoints.length;p++){"undefined"===typeof n.dataPoints[p].x&&(n.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));n.dataPoints[p].x.getTime?(f=!0,b=n.dataPoints[p].x.getTime()):b=n.dataPoints[p].x;e=s(n.dataPoints[p].y)?null:n.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=
b/n.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-n.dataPoints[p-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);s(e)||null===n.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/n.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-n.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),C[b]=C[b]?C[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=
...
(t=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var B=0;B<e.length;B++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==
k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(B=0;B<e.length;B++)if(null===e[B]&&g<b){c.viewPortMin=
...
this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(t.dataPoints[C].x&&t.dataPoints[C].x.getTime||"dateTime"===t.xValueType)f=!0;for(C=0;C<t.dataPoints.length;C++)"undefined"!==typeof t.dataPoints[C].isCumulativeSum&&!0===t.dataPoints[C].isCumulativeSum?(t.dataPointEOs[C].cumulativeSumYStartValue=0,t.dataPointEOs[C].cumulativeSum=0===C?0:t.dataPointEOs[C-1].cumulativeSum,t.dataPoints[C].y=0===C?0:t.dataPointEOs[C-1].cumulativeSum):"undefined"!==typeof t.dataPoints[C].isIntermediateSum&&
!0===t.dataPoints[C].isIntermediateSum?(t.dataPointEOs[C].cumulativeSumYStartValue=p,t.dataPointEOs[C].cumulativeSum=0===C?0:t.dataPointEOs[C-1].cumulativeSum,t.dataPoints[C].y=0===C?0:b,p=0===C?0:t.dataPointEOs[C-1].cumulativeSum,b=0):(e="number"!==typeof t.dataPoints[C].y?0:t.dataPoints[C].y,t.dataPointEOs[C].cumulativeSumYStartValue=0===C?0:t.dataPointEOs[C-1].cumulativeSum,t.dataPointEOs[C].cumulativeSum=0===C?e:t.dataPointEOs[C-1].cumulativeSum+e,b+=e);for(C=0;C<t.dataPoints.length;C++)if("undefined"===
typeof t.dataPoints[C].x&&(t.dataPoints[C].x=C+(a.axisX.logarithmic?1:0)),t.dataPoints[C].x.getTime?(f=!0,b=t.dataPoints[C].x.getTime()):b=t.dataPoints[C].x,e=t.dataPoints[C].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[C].cumulativeSum<d.min&&(d.min=t.dataPointEOs[C].cumulativeSum),t.dataPointEOs[C].cumulativeSum>d.max&&(d.max=t.dataPointEOs[C].cumulativeSum),0<C&&(a.axisX.logarithmic?(p=b/t.dataPoints[C-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-t.dataPoints[C-1].x,0>p&&
(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==t.dataPoints[C-1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[C].cumulativeSum/t.dataPointEOs[C-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[C].cumulativeSum-t.dataPointEOs[C-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<C)){C-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;t.dataPoints[C].label&&(a.axisX.labels[b]=t.dataPoints[C].label);b<c.viewPortMin&&
(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<C&&(t.dataPointEOs[C-1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[C-1].cumulativeSum),t.dataPointEOs[C-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=t.dataPointEOs[C-1].cumulativeSum));t.dataPointEOs[C].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[C].cumulativeSum);t.dataPointEOs[C].cumulativeSum>d.viewPortMax&&(d.viewPortMax=t.dataPointEOs[C].cumulativeSum)}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};
...
this._axes[l].dataInfo.min;b=(this._axes[l].dataInfo.max+1-C)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(p=q[t],!s(p))){var g=Math.floor((p-C)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],s(p)||(g=Math.floor((p-C)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(n=k[t].max,isFinite(n))for(;t<k.length-1;)if(C=k[t+1].min,isFinite(C)){p=C-n;p>b&&f.push({diff:p,start:n,end:C});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ja(this._zoomButton,this._resetButton),pa(this,this._zoomButton,"pan"),pa(this,this._resetButton,
...
(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))C.push(p),n.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;break}}return{isValid:t,axesWithValidRange:C,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;
...
b=0,e=0,f=0,l=f=e=0,t=0,C=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ka("indexLabelFontSize",n.dataPoint,n.dataSeries),t=ka("indexLabelFontFamily",n.dataPoint,n.dataSeries),C=ka("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ka("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ka("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ka("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
...
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))z="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===z&&(z="inside");else if("bubble"===p||"scatter"===p)z="inside";q=n.point.x-("horizontal"===A?C/2:C/2-r/2);"inside"!==z?(e=c.y1,f=c.y2,0<y?(g=n.point.y+("horizontal"===A?r/2:0)-k-t-b,g<e&&(g="auto"===z?Math.max(n.point.y,e)+r/2+t:e+r/2+t,x=g+k>n.point.y)):(g=n.point.y+r/2+t+b,g>f-k&&(g="auto"===z?Math.min(n.point.y,f)+r/2-k-t:f+r/2-k,x=g<n.point.y))):(e=Math.max(n.bounds.y1,
c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<y?Math.max(n.bounds.y1,c.y1)+r/2+t:Math.min(n.bounds.y2,c.y2)+r/2-k+t:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===A?t:0),0<y?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-t,c.y1+t))):(g=Math.min(n.point.y,b),g>f-k-t&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+t,c.y2-k-t))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
0<=p.indexOf("scatter")?(z="auto",l=4):0<=p.indexOf("stacked")?"auto"===z&&(z="inside"):"bubble"===p&&(z="inside"),g=n.point.y+r/2-k/2+t,"inside"!==z?(e=c.x1,f=c.x2,0>y?(q=n.point.x-("horizontal"===A?C:C-r/2)-l-b,q<e&&(q="auto"===z?Math.max(n.point.x,e)+l:e+l,x=q+C>n.point.x)):(q=n.point.x+("horizontal"===A?0:r/2)+l+b,q>f-C-l-b&&(q="auto"===z?Math.min(n.point.x,f)-("horizontal"===A?C:C/2)-l:f-C-l,x=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
...
n.point.y<c.y2||!x))&&(d.lineWidth=B,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(N(m,B)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:C+l)+("vertical"===A?-r/2:0),g+("vertical"===A?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+C/2-("horizontal"===A?0:r/2),g+("vertical"===A?(g-k<n.point.y?0:-k)+t:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+C/2-("horizontal"===A?0:r/2),g+("vertical"===
...
dataSeriesIndex:C};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,s,z;c.beginPath();if(0<n.length){for(var A=!1,u=0;u<n.length;u++)if(s=n[u].x.getTime?n[u].x.getTime():n[u].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!A)))if("number"!==typeof n[u].y)0<u&&!(k.connectNullData||A||m)&&(c.stroke(),w&&b.stroke()),A=
!0;else{s=a.axisX.convertValueToPixel(s);z=a.axisY.convertValueToPixel(n[u].y);var v=k.dataPointIds[u];this._eventManager.objectMap[v]={id:v,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:s,y1:z};m||A?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(s,z),w&&b.lineTo(s,z)):(c.beginPath(),c.moveTo(s,z),w&&(b.beginPath(),
b.moveTo(s,z))),A=m=!1):(c.lineTo(s,z),w&&b.lineTo(s,z),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(s,z),w&&(b.stroke(),b.beginPath(),b.moveTo(s,z))));l={x:s,y:z};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(s,z),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0!==n[u].markerSize&&(0<n[u].markerSize||0<k.markerSize)){var D=
k.getMarkerProperties(u,s,z,c);f.push(D);v=Q(v);w&&f.push({x:s,y:z,ctx:b,type:D.type,size:D.size,color:v,borderColor:v,borderThickness:D.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:s,y:z},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}$.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStepLine=
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,t=0;t<a.dataSeriesIndexes.length;t++){var C=a.dataSeriesIndexes[t],k=this.data[C];c.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);c.setLineDash(g)}var r=
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:C};r=Q(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,s,z;c.beginPath();if(0<n.length){for(var A=!1,u=0;u<n.length;u++)if(s=n[u].getTime?n[u].x.getTime():n[u].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!A)))if("number"!==typeof n[u].y)0<
u&&!(k.connectNullData||A||m)&&(c.stroke(),w&&b.stroke()),A=!0;else{var v=z;s=a.axisX.convertValueToPixel(s);z=a.axisY.convertValueToPixel(n[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:s,y1:z};m||A?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(s,v),c.lineTo(s,z),w&&(b.lineTo(s,v),b.lineTo(s,z))):(c.beginPath(),c.moveTo(s,z),w&&(b.beginPath(),b.moveTo(s,z))),A=m=!1):(c.lineTo(s,v),w&&b.lineTo(s,v),c.lineTo(s,z),w&&b.lineTo(s,z),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(s,z),w&&(b.stroke(),b.beginPath(),b.moveTo(s,z))));l={x:s,y:z};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(s,z),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,
c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));0!==n[u].markerSize&&(0<n[u].markerSize||0<k.markerSize)&&(v=k.getMarkerProperties(u,s,z,c),f.push(v),D=Q(D),w&&f.push({x:s,y:z,ctx:b,type:v.type,size:v.size,color:D,borderColor:D,borderThickness:v.borderThickness}));(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:s,y:z},direction:0>n[u].y===a.axisY.reversed?
...
return{source:d,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=v(a,2);if(0<a.length){b.beginPath();w&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);w&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var C=a.dataSeriesIndexes[t],k=this.data[C];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:C};r=Q(r);e.strokeStyle=r;e.lineWidth=
0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,u,s,z=[];b.beginPath();if(0<n.length)for(s=!1,m=0;m<n.length;m++)if(u=n[m].getTime?n[m].x.getTime():n[m].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof n[m].y)0<m&&!s&&(k.connectNullData?b.setLineDash&&(0<z.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(z[z.length-
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(z),z=[])),s=!0;else{u=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(n[m].y);var A=k.dataPointIds[m];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:m,x1:u,y1:s};z[z.length]={x:u,y:s};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,z[z.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,z[z.length-1].newLineDashArray=
N(p,k.lineThickness)):(p=k.lineDashType,z[z.length-1].newLineDashArray=g)));if(0!==n[m].markerSize&&(0<n[m].markerSize||0<k.markerSize)){var Oa=k.getMarkerProperties(m,u,s,b);l.push(Oa);A=Q(A);w&&l.push({x:u,y:s,ctx:e,type:Oa.type,size:Oa.size,color:A,borderColor:A,borderThickness:Oa.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:u,y:s},direction:0>n[m].y===a.axisY.reversed?
1:-1,color:r});s=!1}d(z)}$.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,
dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,C,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?
...
g=this.data[q],r=g.dataPoints;if(0<r.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<r.length;f++)if(r[f].getTime?C=r[f].x.getTime():C=r[f].x,!(C<a.axisX.dataInfo.viewPortMin||C>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(C);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,u;
0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ea(c,a.axisX.reversed?m:l,t,a.axisX.reversed?l:m,u,b,0,null,h&&(a.axisY.reversed?0>r[f].y:0<=r[f].y),(a.axisY.reversed?0<=r[f].y:0>r[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:m,y2:u};b=Q(b);w&&ea(this._eventManager.ghostCtx,a.axisX.reversed?m:l,t,a.axisX.reversed?l:m,u,b,0,null,!1,!1,
!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:m,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.yScaleAnimation,easingFunction:J.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=
...
-Infinity,k));r<k&&(r=k);r>g&&(r=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length)for(var s=5<r&&m.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;n=n-a.plotType.plotUnits.length*r/2+a.index*r<<0;var z=n+r<<0,A;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;p=a.axisY.convertValueToPixel(t[b]);A=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0>=u[k].y)C[b]=p+("undefined"!==typeof C[b]?C[b]:0),A=a.axisY.convertValueToPixel(C[b]),p=l[b]?l[b]:q,l[b]=A;else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var v="undefined"!==typeof f[b]?f[b]:0;p-=v;A=q-v;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=v+(A-p)}else v="undefined"!==typeof l[b]?l[b]:0,A=p+v,p=q+v,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y2-A)&&(A=e.y2),l[b]=v+(A-p);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];ea(c,n,a.axisY.reversed?A:
p,z,a.axisY.reversed?p:A,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:z,y2:A};b=Q(b);w&&ea(this._eventManager.ghostCtx,n,p,z,A,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:m,
point:{x:n+(z-n)/2,y:0<=u[k].y?p:A},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:n,y1:Math.min(p,A),x2:z,y2:Math.max(p,A)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
p/2-(a.previousDataSeriesCount+n)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ea(c,a.axisY.reversed?l:u,a.axisX.reversed?m:t,a.axisY.reversed?u:l,a.axisX.reversed?t:m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:m};b=Q(b);w&&ea(this._eventManager.ghostCtx,
u,a.axisX.reversed?m:t,l,a.axisX.reversed?t:m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:u,y:t+(m-t)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:m},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
(r=k);r>g&&(r=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,
!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);p=p-a.plotType.plotUnits.length*r/2+a.index*r<<0;var z=p+r<<0,A;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(A=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=u[k].y+(C[b]?C[b]:0),n=l[b]?l[b]:
q,l[b]=A=a.axisY.convertValueToPixel(C[b]);else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var v=f[b]?f[b]:0;A=q+v;n+=v;f[b]=v+(n-A)}else v=l[b]?l[b]:0,A=n-v,n=q-v,l[b]=v+(n-A);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];ea(c,a.axisY.reversed?n:A,p,a.axisY.reversed?A:n,z,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:A,y1:p,x2:n,y2:z};b=Q(b);w&&ea(this._eventManager.ghostCtx,
A,p,n,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:m,point:{x:0<=u[k].y?n:A,y:p+(z-p)/2},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(A,n),y1:p,x2:Math.max(A,n),y2:z},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;p=p-a.plotType.plotUnits.length*r/2+a.index*r<<0;var A=p+r<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=z+(t[b]?t[b]:0);if(0>=t[b])continue;z=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=
z+(C[b]?C[b]:0),n=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(C[b]);else if(n=a.axisY.convertValueToPixel(z),0<=u[k].y){var v=f[b]?f[b]:0;z=q+v;n+=v;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=v+(n-z)}else v=l[b]?l[b]:0,z=n-v,n=q-v,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x1-z)&&(z=e.x1),l[b]=v+(n-z);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];ea(c,a.axisY.reversed?n:z,p,a.axisY.reversed?z:n,A,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];
...
animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){v&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?A=z:0>a.axisY.viewportMaximum?A=t.y1:0<a.axisY.viewportMinimum&&(A=z),f.lineTo(m,A),f.lineTo(v.x,A),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,A),l.lineTo(v.x,A),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,
u),l.beginPath(),l.moveTo(m,u),v={x:m,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,C=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,C=g.id;this._eventManager.objectMap[C]=
...
r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ba)))if("number"!==typeof r[h].y)g.connectNullData||(ba||d)||b(),ba=!0;else{m=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ba?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,v=n,c=g.nullDataLineDashType,f.setLineDash(I)),f.lineTo(m,
u),w&&l.lineTo(m,u)):(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),v={x:m,y:u}),ba=d=!1):(f.lineTo(m,u),w&&l.lineTo(m,u),0==h%250&&b());n={x:m,y:u};h<r.length-1&&(x!==(r[h].lineColor||y)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||y,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(R))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,u,f),C.push(s),Y=Q(Y),w&&C.push({x:m,y:u,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:D})}b();$.drawMarkers(C)}}w&&
...
easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderSplineArea=function(a){function d(){var c=v(B,2);if(0<c.length){if(0<n.lineThickness){b.beginPath();b.moveTo(c[0].x,c[0].y);c[0].newStrokeStyle&&(b.strokeStyle=c[0].newStrokeStyle);c[0].newLineDashArray&&b.setLineDash(c[0].newLineDashArray);for(var d=0;d<c.length-3;d+=3)if(b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle||
c[d+3].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(c[d+3].x,c[d+3].y),c[d+3].newStrokeStyle&&(b.strokeStyle=c[d+3].newStrokeStyle),c[d+3].newLineDashArray&&b.setLineDash(c[d+3].newLineDashArray);b.stroke()}b.beginPath();b.moveTo(c[0].x,c[0].y);w&&(e.beginPath(),e.moveTo(c[0].x,c[0].y));for(d=0;d<c.length-3;d+=3)b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),w&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&
0<=a.axisY.viewportMaximum?s=m:0>a.axisY.viewportMaximum?s=f.y1:0<a.axisY.viewportMinimum&&(s=m);u={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,s);b.lineTo(u.x,s);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,s),e.lineTo(u.x,s),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&
e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=Q(l);e.fillStyle=l;var l=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s,u=null,B=[];if(0<p.length){var z=n._colorSet[q%n._colorSet.length],
A=n.lineColor=n.options.lineColor||z,y=A;b.fillStyle=z;b.strokeStyle=A;b.lineWidth=n.lineThickness;var D="solid";if(b.setLineDash){var x=N(n.nullDataLineDashType,n.lineThickness),D=n.lineDashType,E=N(D,n.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<B.length&&(n.options.nullDataLineDashType||
...
p[q].lineDashType,B[B.length-1].newLineDashArray=N(D,n.lineThickness)):(D=n.lineDashType,B[B.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var R=n.getMarkerProperties(q,g,r,b);l.push(R);I=Q(I);w&&l.push({x:g,y:r,ctx:e,type:R.type,size:R.size,color:I,borderColor:I,borderThickness:R.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,
point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:z});r=!1}d();$.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){y&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?v=z:0>a.axisY.viewportMaximum?v=t.y1:0<a.axisY.viewportMinimum&&(v=z),f.lineTo(s,v),f.lineTo(y.x,v),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=
1,w&&(l.lineTo(s,v),l.lineTo(y.x,v),l.closePath(),l.fill()),f.beginPath(),f.moveTo(s,u),l.beginPath(),l.moveTo(s,u),y={x:s,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,h=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=
a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=Q(h);l.fillStyle=h;h=[];d=!0;var m=0,s,u,B,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),v,y=null;c=!1;if(0<r.length){var D=g._colorSet[m%g._colorSet.length],x=g.lineColor=g.options.lineColor||D,E=x;f.fillStyle=D;f.strokeStyle=x;f.lineWidth=g.lineThickness;var I="solid";if(f.setLineDash){var R=N(g.nullDataLineDashType,g.lineThickness),
I=g.lineDashType,ba=N(I,g.lineThickness);f.setLineDash(ba)}for(;m<r.length;m++)if(B=r[m].x.getTime?r[m].x.getTime():r[m].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=u;"number"!==typeof r[m].y?(g.connectNullData||(c||d)||b(),c=!0):(s=a.axisX.convertValueToPixel(B),u=a.axisY.convertValueToPixel(r[m].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||I===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=
s,c=u,s=n.x,u=n.y,b(),f.moveTo(n.x,n.y),s=d,u=c,y=n,I=g.nullDataLineDashType,f.setLineDash(R)),f.lineTo(s,Y),f.lineTo(s,u),w&&(l.lineTo(s,Y),l.lineTo(s,u))):(f.beginPath(),f.moveTo(s,u),w&&(l.beginPath(),l.moveTo(s,u)),y={x:s,y:u}),c=d=!1):(f.lineTo(s,Y),w&&l.lineTo(s,Y),f.lineTo(s,u),w&&l.lineTo(s,u),0==m%250&&b()),n={x:s,y:u},m<r.length-1&&(E!==(r[m].lineColor||x)||I!==(r[m].lineDashType||g.lineDashType))&&(b(),E=r[m].lineColor||x,f.strokeStyle=E,f.setLineDash&&(r[m].lineDashType?(I=r[m].lineDashType,
f.setLineDash(N(I,g.lineThickness))):(I=g.lineDashType,f.setLineDash(ba)))),B=g.dataPointIds[m],this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:s,y1:u},0!==r[m].markerSize&&(0<r[m].markerSize||0<g.markerSize)&&(Y=g.getMarkerProperties(m,s,u,f),h.push(Y),B=Q(B),w&&h.push({x:s,y:u,ctx:l,type:Y.type,size:Y.size,color:B,borderColor:B,borderThickness:Y.borderThickness})),(r[m].indexLabel||g.indexLabel||r[m].indexLabelFormatter||g.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stepArea",dataPoint:r[m],dataSeries:g,point:{x:s,y:u},direction:0>r[m].y===a.axisY.reversed?1:-1,color:D}))}b();$.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<D.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&z.lineTo(a.x,
a.y)}b.closePath();b.globalAlpha=D.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(z.closePath(),z.fill(),z.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,u,B=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();w&&z.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(z.beginPath(),
...
u===D.lineDashType&&D.lineDashType!==D.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(u),k.push(s),u=D.nullDataLineDashType,b.setLineDash(R)),b.lineTo(g,r),w&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(z.beginPath(),z.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),w&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&z.moveTo(g,r),k.push({x:g,y:B-aa})));m={x:g,y:r};q<x.length-1&&(I!==(x[q].lineColor||E)||u!==(x[q].lineDashType||D.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,
...
r,b),t.push(aa),f=Q(G),w&&t.push({x:g,y:r,ctx:z,type:aa.type,size:aa.size,color:f,borderColor:f,borderThickness:aa.borderThickness}));(fa.indexLabel||D.indexLabel||fa.indexLabelFormatter||D.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:D,point:{x:g,y:r},direction:0>x[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&z.moveTo(g,r)}delete D.dataPointIndexes}$.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),z.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:J.xClipAnimation,easingFunction:J.easing.linear,animationBase:0}}};m.prototype.renderBubble=
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?m/2:r+(m-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;$.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:s};
s=Q(u);w&&$.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints;if(0<n.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,
...
this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=Q(p),w&&$.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||n[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),
p=f,q=l)}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,
animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=0,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,f=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?
...
e&&(r=e);r>f&&(r=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var v=a.dataSeriesIndexes[m],u=this.data[v],B=u.dataPoints;if(0<B.length)for(var z=5<r&&u.bevelEnabled?!0:!1,t=0;t<B.length;t++)if(B[t].getTime?g=B[t].x.getTime():g=B[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(B[t].y)&&B[t].y.length&&"number"===typeof B[t].y[0]&&
"number"===typeof B[t].y[1]&&"number"===typeof B[t].y[2]&&"number"===typeof B[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(B[t].y[0]);n=a.axisY.convertValueToPixel(B[t].y[1]);p=a.axisY.convertValueToPixel(B[t].y[2]);q=a.axisY.convertValueToPixel(B[t].y[3]);var A=h-r/2<<0,y=A+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=B[t].color?B[t].color:u._colorSet[0],D=Math.round(Math.max(1,0.15*r)),x=0===D%2?0:0.5,E=u.dataPointIds[t];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:t,x1:A,y1:k,x2:y,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:D,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=D;b.lineWidth=Math.max(D,4);"candlestick"===u.type?(c.moveTo(h-x,n),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),ea(c,A,Math.min(k,q),y,Math.max(k,q),B[t].y[0]<=B[t].y[3]?u.risingColor:f,D,e,z,z,!1,!1,u.fillOpacity),w&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,Math.min(k,
q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),ea(b,A,Math.min(k,q),y,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-x,n),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(A,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(y,q),c.stroke(),w&&(e=Q(E),b.strokeStyle=e,b.moveTo(h-x,n),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(A,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(y,q),b.stroke()));(B[t].indexLabel||u.indexLabel||
B[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:B[t],dataSeries:u,point:{x:A+(y-A)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:A,y1:Math.min(n,p),x2:y,y2:Math.max(n,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
if(0<z.length)for(var A=5<r&&B.bevelEnabled?!0:!1,l=0;l<z.length;l++)if(z[l].getTime?g=z[l].x.getTime():g=z[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(z[l].y)&&z[l].y.length&&"number"===typeof z[l].y[0]&&"number"===typeof z[l].y[1]&&"number"===typeof z[l].y[2]&&"number"===typeof z[l].y[3]&&"number"===typeof z[l].y[4]&&5===z[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(z[l].y[0]);k=a.axisY.convertValueToPixel(z[l].y[1]);n=a.axisY.convertValueToPixel(z[l].y[2]);
p=a.axisY.convertValueToPixel(z[l].y[3]);q=a.axisY.convertValueToPixel(z[l].y[4]);var y=t-r/2<<0,D=t+r/2<<0,e=z[l].color?z[l].color:B._colorSet[0],x=Math.round(Math.max(1,0.15*r)),E=0===x%2?0:0.5,I=z[l].whiskerColor?z[l].whiskerColor:z[l].color?B.whiskerColor?B.whiskerColor:z[l].color:B.whiskerColor?B.whiskerColor:e,R="number"===typeof z[l].whiskerThickness?z[l].whiskerThickness:"number"===typeof B.options.whiskerThickness?B.whiskerThickness:x,ba=z[l].whiskerDashType?z[l].whiskerDashType:B.whiskerDashType,
Y=s(z[l].whiskerLength)?s(B.options.whiskerLength)?r:B.whiskerLength:z[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>r?r:parseInt(Y)*r/100:r,fa=1===Math.round(R)%2?0.5:0,la=z[l].stemColor?z[l].stemColor:z[l].color?B.stemColor?B.stemColor:z[l].color:B.stemColor?B.stemColor:e,aa="number"===typeof z[l].stemThickness?z[l].stemThickness:"number"===typeof B.options.stemThickness?B.stemThickness:x,G=1===Math.round(aa)%2?0.5:0,F=z[l].stemDashType?z[l].stemDashType:
B.stemDashType,M=z[l].lineColor?z[l].lineColor:z[l].color?B.lineColor?B.lineColor:z[l].color:B.lineColor?B.lineColor:e,L="number"===typeof z[l].lineThickness?z[l].lineThickness:"number"===typeof B.options.lineThickness?B.lineThickness:x,O=z[l].lineDashType?z[l].lineDashType:B.lineDashType,K=1===Math.round(L)%2?0.5:0,S=B.upperBoxColor,va=B.lowerBoxColor,qa=s(B.options.fillOpacity)?1:B.fillOpacity,P=B.dataPointIds[l];this._eventManager.objectMap[P]={id:P,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,
x1:y,y1:h,x2:D,y2:k,x3:t,y3:n,x4:t,y4:p,y5:q,borderThickness:x,color:e,stemThickness:aa,stemColor:la,whiskerThickness:R,whiskerLength:Y,whiskerColor:I,lineThickness:L,lineColor:M};c.save();0<aa&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=aa,c.setLineDash&&c.setLineDash(N(F,aa)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,n),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();ea(c,y,Math.min(q,k),D,Math.max(k,q),va,0,e,m?A:!1,m?!1:A,!1,!1,qa);c.beginPath();
ea(c,y,Math.min(n,q),D,Math.max(q,n),S,0,e,m?!1:A,m?A:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(y-E,Math.min(k,n)-E,D-y+2*E,Math.max(k,n)-Math.min(k,n)+2*E);c.stroke();c.save();0<L&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(O,L)),c.strokeStyle=M,c.lineWidth=L,c.moveTo(y,q-K),c.lineTo(D,q-K),c.stroke());c.restore();c.save();0<R&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(ba,R)),c.strokeStyle=I,c.lineWidth=R,c.moveTo(t-Y/2<<0,p-fa),c.lineTo(t+Y/2<<0,p-fa),
c.stroke(),c.moveTo(t-Y/2<<0,h+fa),c.lineTo(t+Y/2<<0,h+fa),c.stroke());c.restore();w&&(e=Q(P),b.strokeStyle=e,b.lineWidth=aa,0<aa&&(b.moveTo(t-E-G,k),b.lineTo(t-E-G,Math.max(h,p)),b.stroke(),b.moveTo(t-E-G,Math.min(h,p)),b.lineTo(t-E-G,n),b.stroke()),ea(b,y,Math.max(k,n),D,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<R&&(b.beginPath(),b.lineWidth=R,b.moveTo(t+Y/2,p-fa),b.lineTo(t-Y/2,p-fa),b.stroke(),b.moveTo(t+Y/2,h+fa),b.lineTo(t-Y/2,h+fa),b.stroke()));(z[l].indexLabel||B.indexLabel||z[l].indexLabelFormatter||
...
5<k&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?h=g[f].x.getTime():h=g[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(h);l=a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+
n)*k<<0,v=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:v,y2:t};ea(c,a.axisX.reversed?v:m,l,a.axisX.reversed?m:v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=Q(u);w&&ea(this._eventManager.ghostCtx,a.axisX.reversed?v:m,l,a.axisX.reversed?m:v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||
q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(v-m)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,t),x2:v,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,
...
animationBase:0}}};m.prototype.renderError=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,l=this.plotArea,t=0,h,k,n,p,q,g,r,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),
this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var v=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&v||v++;for(var B=0;B<a.dataSeriesIndexes.length;B++){var z=a.dataSeriesIndexes[B],A=this.data[z],x=A.dataPoints,D=s(A._linkedSeries)?!1:A._linkedSeries.type.match(/(bar|column)/ig)&&A._linkedSeries.visible?!0:!1,E=0;if(D)for(e=A._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||
!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&E||(this.data[u].type.match(/(range)/ig)&&(f=!0),E++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(D?v:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(D?v:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(D?v:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&
(u=e);u>t&&(u=t);if(0<x.length)for(var F=A._colorSet,t=0;t<x.length;t++){var e=A.lineColor=A.options.color?A.options.color:F[0],I={color:x[t].whiskerColor?x[t].whiskerColor:x[t].color?A.whiskerColor?A.whiskerColor:x[t].color:A.whiskerColor?A.whiskerColor:e,thickness:s(x[t].whiskerThickness)?A.whiskerThickness:x[t].whiskerThickness,dashType:x[t].whiskerDashType?x[t].whiskerDashType:A.whiskerDashType,length:s(x[t].whiskerLength)?s(A.options.whiskerLength)?u:A.options.whiskerLength:x[t].whiskerLength,
trimLength:s(x[t].whiskerLength)?s(A.options.whiskerLength)?50:0:0};I.length="number"===typeof I.length?0>=I.length?0:I.length>=u?u:I.length:"string"===typeof I.length?parseInt(I.length)*u/100>u?u:parseInt(I.length)*u/100>u:u;I.thickness="number"===typeof I.thickness?0>I.thickness?0:Math.round(I.thickness):2;var R={color:x[t].stemColor?x[t].stemColor:x[t].color?A.stemColor?A.stemColor:x[t].color:A.stemColor?A.stemColor:e,thickness:x[t].stemThickness?x[t].stemThickness:A.stemThickness,dashType:x[t].stemDashType?
x[t].stemDashType:A.stemDashType};R.thickness="number"===typeof R.thickness?0>R.thickness?0:Math.round(R.thickness):2;x[t].getTime?r=x[t].x.getTime():r=x[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(x[t].y)&&x[t].y.length&&"number"===typeof x[t].y[0]&&"number"===typeof x[t].y[1]){var ba=a.axisX.convertValueToPixel(r);b?k=ba:h=ba;ba=a.axisY.convertValueToPixel(x[t].y[0]);b?n=ba:q=ba;ba=a.axisY.convertValueToPixel(x[t].y[1]);b?p=ba:g=ba;b?(q=a.axisX.reversed?k+(D?v:
1)*u/2-(D?E-1:0)*u<<0:k-(D?v:1)*u/2+(D?E-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(D?v:1)*u/2-(D?E-1:0)*u<<0:h-(D?v:1)*u/2+(D?E-1:0)*u<<0,p=a.axisX.reversed?n-u<<0:n+u<<0);!b&&q>g&&(ba=q,q=g,g=ba);b&&n>p&&(ba=n,n=p,p=ba);ba=A.dataPointIds[t];this._eventManager.objectMap[ba]={id:ba,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:R,whiskerProperties:I};y(c,Math.min(n,p),
...
dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:t,y2:v};b=Q(b);w&&ea(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:t,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",
dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?t:l,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(v){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();
b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,m);e.beginPath();e.moveTo(r,m);v={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),
e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,u,v=null;if(0<p.length){var z=n._colorSet[g%n._colorSet.length],A=n.lineColor=n.options.lineColor||z,x=A;b.fillStyle=z;b.strokeStyle=A;b.lineWidth=n.lineThickness;var D="solid";if(b.setLineDash){var y=N(n.nullDataLineDashType,
n.lineThickness),D=n.lineDashType,E=N(D,n.lineThickness);b.setLineDash(E)}for(var I=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!I)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||I?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||
D===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,D=n.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,m),w&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),v={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),w&&(e.beginPath(),e.moveTo(r,m))),I=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),w&&e.lineTo(r,m),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,
y2:s};g<p.length-1&&(x!==(p[g].lineColor||A)||D!==(p[g].lineDashType||n.lineDashType))&&(d(),x=p[g].lineColor||A,h[h.length-1].newStrokeStyle=x,b.strokeStyle=x,b.setLineDash&&(p[g].lineDashType?(D=p[g].lineDashType,h[h.length-1].newLineDashArray=N(D,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(D=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var R=n.getMarkerProperties(g,r,s,b);f.push(R);var ba=Q(u);
w&&f.push({x:r,y:s,ctx:e,type:R.type,size:R.size,color:ba,borderColor:ba,borderThickness:R.borderThickness});R=n.getMarkerProperties(g,r,m,b);f.push(R);ba=Q(u);w&&f.push({x:r,y:m,ctx:e,type:R.type,size:R.size,color:ba,borderColor:ba,borderThickness:R.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?
...
a.dataSeriesIndexes[h],k=this.data[m],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],p=0,q,g,r,s=[],x=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],B=k.lineColor=k.options.lineColor||u,z=B;b.fillStyle=u;b.lineWidth=k.lineThickness;var A="solid",y;if(b.setLineDash){var D=N(k.nullDataLineDashType,k.lineThickness),A=k.lineDashType;y=N(A,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():
n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:p,x1:q,y1:g,y2:r};s[s.length]={x:q,y:g};x[x.length]={x:q,y:r};p<n.length-1&&(z!==
(n[p].lineColor||B)||A!==(n[p].lineDashType||k.lineDashType))&&(z=n[p].lineColor||B,s[s.length-1].newStrokeStyle=z,b.setLineDash&&(n[p].lineDashType?(A=n[p].lineDashType,s[s.length-1].newLineDashArray=N(A,k.lineThickness)):(A=k.lineDashType,s[s.length-1].newLineDashArray=y)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var I=Q(E);w&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:I,borderColor:I,borderThickness:F.borderThickness});
F=k.getMarkerProperties(p,q,r,b);f.push(F);I=Q(E);w&&f.push({x:q,y:r,ctx:e,type:F.type,size:F.size,color:I,borderColor:I,borderThickness:F.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,
y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=D,A=k.nullDataLineDashType):(d(y,B),s=[],x=[])),g=!0;d(y,B);$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
...
e=null,f=this.plotArea,l=0,h,m,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0;var q=a.axisX.dataInfo.minDiff;isFinite(q)||(q=0.3*Math.abs(a.axisX.range));q=this.options.dataPointWidth?
this.dataPointWidth:0.6*(f.width*(a.axisX.logarithmic?Math.log(q)/Math.log(a.axisX.range):Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);
...
2?-0.5:0;if(0<v.length)for(var z=5<q&&s.bevelEnabled?!0:!1,x=!1,y=null,D=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!x&&s.connectNullData)var E=s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;x=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);
h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:F,y2:k};var I=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;ea(c,a.axisX.reversed?F:h,a.axisY.reversed?k:m,a.axisX.reversed?
h:F,a.axisY.reversed?m:k,I,0,I,z,z,!1,!1,s.fillOpacity);e=Q(e);w&&ea(this._eventManager.ghostCtx,a.axisX.reversed?F:h,m,a.axisX.reversed?h:F,k,e,0,null,!1,!1,!1,!1);var R,I=h;R="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?m:k:0<v[l].y?k:m;0<l&&y&&(!x||s.connectNullData)&&(x&&c.setLineDash&&c.setLineDash(N(E,u)),c.beginPath(),c.moveTo(y,D-B),c.lineTo(I,R-B),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(y,
D-B),b.lineTo(I,R-B),0<u&&b.stroke()));x=!1;y=F;D=0<v[l].y?m:k;I=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(I=N(I,u),c.setLineDash(I));(v[l].indexLabel||s.indexLabel||v[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:s,point:{x:h+(F-h)/2,y:0<=v[l].y?m:k},
direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:F,y2:Math.max(m,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,
f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:J.fadeInAnimation,easingFunction:J.easing.easeInQuad,animationBase:0}}};var ha=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!w){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(k&&n){for(var a=0,b=0,c=0,d=0,e=0;e<n.length;e++){var f=n[e],l=k.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=e;g[e].dataSeriesIndex=0;var h=g[e],p={percent:null,total:null},t=null,p=m.getPercentAndTotal(k,
f);if(k.indexLabelFormatter||f.indexLabelFormatter)t={chart:m.options,dataSeries:k,dataPoint:f,total:p.total,percent:p.percent};p=f.indexLabelFormatter?f.indexLabelFormatter(t):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=h;h.center={x:z.x,y:z.y};h.y=f.y;h.radius=D;h.percentInnerRadius=F;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;
...
2<k&&p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c>h&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c-h);c=p.indexLabelTextBlock.y+c;k=0;k="right"===p.hemisphere?z.x+Math.sqrt(Math.pow(v,2)-Math.pow(c-z.y,2)):z.x-Math.sqrt(Math.pow(v,2)-Math.pow(c-z.y,2));t=z.x+D*Math.cos(p.midAngle);q=z.y+D*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(k-t,2)+Math.pow(c-q,2));t=Math.acos(D/v);q=Math.acos((v*v+D*D-q*q)/(2*D*v));c=q<t?c-p.indexLabelTextBlock.y:0;k=null;for(h=1;h<n.length;h++)if(k=
...
D-d<=E)l=!1;l&&(D-=d);d=0;if("inside"!==k.indexLabelPlacement){v=D*w;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=z.x+v*Math.cos(h.midAngle);h.indexLabelTextBlock.y=z.y+v*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=D;h.percentInnerRadius=F}for(var t,s,a=0;a<n.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];s=g[u];var x=0,x=b(t,s)-r;if(0>x){for(var A=s=0,y=0;y<n.length;y++)y!==a&&g[y].hemisphere===h.hemisphere&&(g[y].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:
A++);s=x/(s+A||1)*A;var A=-1*(x-s),J=y=0;"right"===h.hemisphere?(y=f(a,s),A=-1*(x-y),J=f(u,A),+J.toFixed(B)<+A.toFixed(B)&&+y.toFixed(B)<=+s.toFixed(B)&&f(a,-(A-J))):(y=f(u,s),A=-1*(x-y),J=f(a,A),+J.toFixed(B)<+A.toFixed(B)&&+y.toFixed(B)<=+s.toFixed(B)&&f(u,-(A-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],v="pie"===k.type?0.7*D:0.8*D,u=z.x+v*Math.cos(h.midAngle),s=z.y+v*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),
...
b.indexLabelLineThickness:"number"===typeof u.indexLabelLineThickness?u.indexLabelLineThickness:2;p=b.indexLabelLineDashType||u.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[A];x._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:A,dataSeriesIndex:0,funnelSection:P[u.reversed?B.length-1-A:A]};"inside"===u.indexLabelPlacement&&(C[A]=A!==ca?u.reversed?P[A].x2-P[A].x1:
P[A].x3-P[A].x4:P[A].x3-P[A].x6,20>C[A]&&(C[A]=A!==ca?u.reversed?P[A].x3-P[A].x4:P[A].x2-P[A].x1:P[A].x2-P[A].x1,C[A]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:C[A];if(t>C[A]||0>t)t=C[A];v[A]="inside"===u.indexLabelPlacement?P[A].height:!1;z=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)y={chart:x.options,dataSeries:u,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(y):b.indexLabel?
x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(y):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?b.label:"";0>=n&&(n=0);1E3>t&&1E3-t<r&&(t+=1E3-t);Q.roundRect||Aa(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:t,maxHeight:!1===v[A]?q?4.28571429*f:1.5*f:v[A],text:b,padding:da});c.measureText();H.push({textBlock:c,id:u.reversed?D:A,isDirty:!1,lineColor:a,
lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=L-Z-S/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=H.length-1;0<=l;l--){g=B[H[l].id];c=H[l];d=c.textBlock;b=(a=q(l)<P.length?H[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=H.length-1;0<=l;l--)a=P[l],H[l].textBlock.maxWidth=
f[f.length-(l+1)],H[l].textBlock.measureText(),H[l].textBlock.x=L-k,c=H[l].textBlock.height<H[l].textBlock.maxHeight?H[l].textBlock.height:H[l].textBlock.maxHeight,e=H[l].textBlock.width<H[l].textBlock.maxWidth?H[l].textBlock.width:H[l].textBlock.maxWidth,H[l].height=c,H[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[l].textBlock.y=c-H[l].height/2,u.reversed?(H[l].textBlock.y+H[l].height>V+A&&(H[l].textBlock.y=V+A-H[l].height),H[l].textBlock.y<qa-A&&(H[l].textBlock.y=qa-A)):
(H[l].textBlock.y<V-A&&(H[l].textBlock.y=V-A),H[l].textBlock.y+H[l].height>qa+A&&(H[l].textBlock.y=qa+A-H[l].height))}function f(){var a,b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<P.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=P[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+S,H[e].textBlock.y=
c-H[e].height/2,u.reversed?(H[e].textBlock.y+H[e].height>V+A&&(H[e].textBlock.y=V+A-H[e].height),H[e].textBlock.y<qa-A&&(H[e].textBlock.y=qa-A)):(H[e].textBlock.y<V-A&&(H[e].textBlock.y=V-A),H[e].textBlock.y+H[e].height>qa+A&&(H[e].textBlock.y=qa+A-H[e].height)));else for(e=0;e<P.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=P[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=
c):H[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=H.length)return 0;var e,f=H[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==P.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,l;f=(O-Y+2*A)/n;l=n;for(var k,h=1;h<l;h++){e=h*f;for(var t=H.length-1;0<=t;t--)!H[t].isDirty&&(H[t].textBlock.y<e&&H[t].textBlock.y+
H[t].height>e)&&(k=q(t),!(k>=H.length-1)&&H[t].textBlock.y+H[t].height+da>H[k].textBlock.y&&(H[t].textBlock.y=H[t].textBlock.y+H[t].height-e>e-H[t].textBlock.y?e+1:e-H[t].height-1))}for(k=P.length-1;0<k;k--)if(!H[k].isDirty){e=p(k);if(0>e&&(e=0,H[e].isDirty))break;if(H[k].textBlock.y<H[e].textBlock.y+H[e].height){d=d||k;f=k;for(l=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+da;){a=a||H[f].textBlock.y+H[f].height;l+=H[f].height;l+=da;f=e;if(0>=f){f=0;l+=H[f].height;break}e=p(f);if(0>e){f=0;l+=H[f].height;
break}}if(f!=k){g=H[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(P[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=H[b.id].height+da,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,n=1,m=0;m<2*n;m++){for(var r=H.length-1;0<=r&&!(0<=p(r)&&p(r),f=H[r],g=f.textBlock,k=(l=q(r)<P.length?
H[q(r)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+da>+k.y.toFixed(6))&&(d=g.y+d+da-k.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<P.length?H[b].textBlock.y:u.reversed?V+A:qa+A)-(0>a?u.reversed?qa-A:V-A:H[a].textBlock.y+H[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=A,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=ha;else{e=A*(1!=W.length||
0!=W[0]&&W[0]!=P.length-1?2:1)/k();for(var q=0;q<P.length;q++){if(1==W.length&&0==W[0]){if(0===q){l.push(ha[q]);d=h;continue}}else 0===q&&(d=-1*h);l.push(ha[q]+d);if(0<=W.indexOf(q)||q<P.length&&0<=W.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<P.length;b++)a.push(l[b]-P[b].y1);return a}();var t={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return J.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<P.length;d++)b=g[d],c=P[d],b*=a,"undefined"===
...
typeof B[R].label&&null!==B[R].label&&0<B[R].label.toString().length)&&(I=!0),!I&&"function"===typeof u.indexLabelFormatter||"function"===typeof B[R].indexLabelFormatter)I=!0;I=I||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&I||(y=(z.width-0.75*F)/2);var R=z.x1+y,L=z.x2-y,Y=z.y1+A,O=z.y2-A,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==B.length){var aa,G;a=75*F/100;var S=
30*(L-a)/100;"funnel"===u.type?(aa=s(u.options.neckHeight)?0.35*E:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===typeof aa&&aa.match(/%$/)?(aa=parseInt(aa),aa=aa*E/100):aa=parseInt(aa),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),aa>E?aa=E:0>=aa&&(aa=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=aa=0,u.reversed=u.reversed?!1:!0);var y=R+a/2,U=R,Z=R+a,V=u.reversed?O:Y,K=y-G/2,$=y+G/2,va=u.reversed?Y+aa:O-aa,qa=u.reversed?Y:O;a=[];var y=[],P=[],
F=[],T=Y,ca,X=(va-V)/(K-U),ea=-X,R="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==R){if(u.reversed)for(F.push(T),G=R.length-1;0<G;G--)T+=R[G],F.push(T);else for(G=0;G<R.length;G++)T+=R[G],F.push(T);if(u.reversed)for(G=0;G<R.length;G++)F[G]<va?(a.push(K),y.push($),ca=G):(a.push((F[G]-V+X*U)/X),y.push((F[G]-V+ea*Z)/ea));else for(G=0;G<R.length;G++)F[G]<va?(a.push((F[G]-V+X*U)/X),y.push((F[G]-V+ea*Z)/ea),ca=G):(a.push(K),y.push($));for(G=0;G<R.length-1;G++)T=u.reversed?B[B.length-
1-G].color?B[B.length-1-G].color:u._colorSet[(B.length-1-G)%u._colorSet.length]:B[G].color?B[G].color:u._colorSet[G%u._colorSet.length],G===ca?P.push({x1:a[G],y1:F[G],x2:y[G],y2:F[G],x3:$,y3:va,x4:y[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:K,y6:va,id:G,height:F[G+1]-F[G],color:T}):P.push({x1:a[G],y1:F[G],x2:y[G],y2:F[G],x3:y[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:T});var da=2,H=[],ga=!1,W=[],ha=[],R=!1;a=a=0;Ba(W);for(G=0;G<B.length;G++)B[G].exploded&&(R=!0,u.reversed?W.push(B.length-
1-G):W.push(G));Q.clearRect(z.x1,z.y1,z.width,z.height);Q.fillStyle=x.backgroundColor;Q.fillRect(z.x1,z.y1,z.width,z.height);if(I&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<B.length;G++)H[G].isDirty||(a=H[G].textBlock.x+H[G].width,a=(L-a)/2,0==G&&(D=a),D>a&&(D=a));for(G=0;G<P.length;G++)P[G].x1+=D,P[G].x2+=D,P[G].x3+=D,P[G].x4+=D,P[G].x5&&(P[G].x5+=D,P[G].x6+=D),H[G].textBlock.x+=D}for(G=0;G<P.length;G++)D=P[G],na(Q,D,u.fillOpacity),ha.push(D.y1);v(Q);I&&u.visible&&
("inside"===u.indexLabelPlacement||x.animationEnabled||n(Q),x.animationEnabled||r());if(!I)for(G=0;G<B.length;G++)D=u.dataPointIds[G],a={id:D,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:P[u.reversed?B.length-1-G:G]},x._eventManager.objectMap[D]=a;!x.animationEnabled&&R?m(x,-1,0):x.animationEnabled&&!x.animatedRender&&m(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?
B.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?B[B.length-1-a].exploded=B[B.length-1-a].exploded?!1:!0:B[a].exploded=B[a].exploded?!1:!0;m(x,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){J.fadeInAnimation(a,b);1<=a&&(m(x,-1,500),v(x.plotArea.ctx||x.ctx))},easingFunction:J.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||
...
d.document.close()}}};m.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");d.setAttribute("class","canvasjs-chart-print-frame");U(d,{position:"relative",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var c=this,b=d.contentWindow||d.contentDocument.document||d.contentDocument;b.document.open();b.document.write('<!DOCTYPE HTML>\n<html><body><img src="'+
...
p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:L.getDefaultLegendMarker(p._linkedSeries.type):L.getDefaultLegendMarker(p.type):p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,
dataSeries:p,dataPoint:null}):p.name,r=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?s(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],v=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,w=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,u=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0;"error"===
p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:u};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var z=p.dataPoints[x],q=z.legendMarkerType?z.legendMarkerType:p.legendMarkerType?p.legendMarkerType:L.getDefaultLegendMarker(p.type),g=z.legendText?z.legendText:
p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:z}):z.name?z.name:"DataPoint: "+(x+1),r=z.legendMarkerColor?z.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:z.color?z.color:p.color?p.color:p._colorSet[x%p._colorSet.length],v=0.75*this.lineHeight,w=z.legendMarkerBorderColor?z.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:z.markerBorderColor?z.markerBorderColor:p.markerBorderColor,
u=z.legendMarkerBorderThickness?z.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:z.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,g=this.chart.replaceKeywordsWithValue(g,z,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:n,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:u};(z.showInLegend||p.showInLegend&&!1!==z.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();
...
"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,r+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,r+this.lineHeight/2),this.ctx.stroke(),s-=0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var v=g-0.08*this.lineHeight+0.1*this.lineHeight,u=r+0.15*this.lineHeight,w=0.7*this.lineHeight,z=w+
0.02*this.lineHeight;this.ctx.moveTo(v,u);this.ctx.lineTo(v+w,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(v+w/2,u);this.ctx.lineTo(v+w/2,u+z);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(v,u+z);this.ctx.lineTo(v+w,u+z);this.ctx.stroke();this.errorMarkerColor.shift()}$.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);
...
q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};ma(L,T);L.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===
a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===a||"stackedBar100"===a||"rangeBar"===a)return"xySwapped";if("pie"===a||"doughnut"===a||"funnel"===a||"pyramid"===a)return"none";"error"!==a&&window.console.log("Unknown Chart Type: "+a);return null};
L.getDefaultLegendMarker=function(a){if("column"===a||"stackedColumn"===a||"stackedLine"===a||"bar"===a||"stackedBar"===a||"stackedBar100"===a||"bubble"===a||"scatter"===a||"stackedColumn100"===a||"stackedLine100"===a||"stepArea"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeBar"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"square";if("line"===a||"stepLine"===a||"spline"===a||"pie"===a||"doughnut"===a)return"circle";if("area"===a||"splineArea"===
a||"stackedArea"===a||"stackedArea100"===a||"funnel"===a||"pyramid"===a)return"triangle";if("error"===a)return"none";window.console.log("Unknown Chart Type: "+a);return null};L.prototype.getDataPointAtX=function(a,d){if(!this.dataPoints||0===this.dataPoints.length)return null;var c={dataPoint:null,distance:Infinity,index:NaN},b=null,e=0,f=0,l=1,h=Infinity,m=0,k=0,n=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(n=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),
...
this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}a=null;for(d=0;d<b.length;d++)a?b[d].distance<=a.distance&&(a=b[d]):a=b[d];return a};L.prototype.getMarkerProperties=function(a,d,c,b){var e=this.dataPoints,f=e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:e[a].color?e[a].color:this.color?this.color:this._colorSet[a%this._colorSet.length],l=e[a].markerBorderColor?e[a].markerBorderColor:this.markerBorderColor?this.markerBorderColor:null,h=s(e[a].markerBorderThickness)?this.markerBorderThickness?
this.markerBorderThickness:null:e[a].markerBorderThickness,m=e[a].markerType?e[a].markerType:this.markerType;a=s(e[a].markerSize)?this.markerSize:e[a].markerSize;return{x:d,y:c,ctx:b,type:m,size:a,color:f,borderColor:l,borderThickness:h}};ma(x,T);x.prototype.createExtraLabelsForLog=function(a){a=(a||0)+1;if(!(5<a)){var d=this.logLabelValues[0]||this.intervalStartPosition;if(Math.log(this.range)/Math.log(d/this.viewportMinimum)<this.noTicks-1){for(var c=x.getNiceNumber((d-this.viewportMinimum)/Math.min(Math.max(2,
this.noTicks-this.logLabelValues.length),3),!0),b=Math.ceil(this.viewportMinimum/c)*c;b<d;b+=c)b<this.viewportMinimum||this.logLabelValues.push(b);this.logLabelValues.sort(Pa);this.createExtraLabelsForLog(a)}}};x.prototype.createLabels=function(){var a,d,c=0,b=0,e,f=0,l=0,b=0,b=this.interval,h=0,m,k=0.6*this.chart.height,n;a=!1;var p=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[],q=p.length?s(this.scaleBreaks.firstBreakIndex)?0:this.scaleBreaks.firstBreakIndex:0;if("axisX"!==this.type||"dateTime"!==
...
c*Math.pow(this.logarithmBase,this.interval):c+this.interval).toFixed(12))){for(;g<p.length&&c>p[g].endValue;g++);a=g<p.length&&c>=p[g].startValue&&c<=p[g].endValue;n=c;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:n,label:this.labels[n]?this.labels[n]:null}):"axisX"===this.type&&this.labels[n]?this.labels[n]:da(n,this.valueFormatString,this.chart._cultureInfo),a=new ia(this.ctx,{x:0,y:0,maxWidth:f,maxHeight:l,angle:this.labelAngle,text:this.prefix+a+this.suffix,
textAlign:this.labelTextAlign,backgroundColor:this.labelBackgroundColor,borderColor:this.labelBorderColor,borderThickness:this.labelBorderThickness,cornerRadius:this.labelCornerRadius,fontSize:this.labelFontSize,fontFamily:this.labelFontFamily,fontWeight:this.labelFontWeight,fontColor:this.labelFontColor,fontStyle:this.labelFontStyle,textBaseline:"middle"}),this._labels.push({position:n,textBlock:a,effectiveHeight:null}))}}else for(this.intervalStartPosition=this.getLabelStartPoint(new Date(this.viewportMinimum),
this.intervalType,this.interval),e=Va(new Date(this.viewportMaximum),this.interval,this.intervalType),g=q,c=this.intervalStartPosition;c<e;Va(c,b,this.intervalType)){for(a=c.getTime();g<p.length&&a>p[g].endValue;g++);n=a;a=g<p.length&&a>=p[g].startValue&&a<=p[g].endValue;a||(a=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.options,value:new Date(n),label:this.labels[n]?this.labels[n]:null}):"axisX"===this.type&&this.labels[n]?this.labels[n]:za(n,this.valueFormatString,this.chart._cultureInfo),
...
l=Math.round(f.x1+P+K);m=Math.round(f.x2-$-Z>n.width-p?n.width-p:f.x2-$-Z);if(a&&0<a.length)for(x=[],g=T=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),x.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),T+=x[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));M.push(x);if(d&&0<d.length)for(z=[],g=X=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(m-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),z.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),X+=z[g],W+=d[g]&&!n.isNavigator?d[g].margin:0;else z.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));N.push(z);if(a&&0<a.length)for(g=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(D)||s(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+u>m&&(h+=0<a[g].labelAngle?E+u-m-$:0):0>a[g].labelAngle?D-w<l&&D-w<a[g].viewportMinimum&&(F=l-(K+a[g].tickLength+A+D-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+u>m&&(h=E+u/2-m-$),D-w<l&&D-w<a[g].viewportMinimum&&(F=l-K-a[g].tickLength-A-D+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
...
W-z[g]-V),x2:m,y2:k,width:m-l,height:k-h},V+=z[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)K=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),K=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+X+W<Math.max(K,p)?Math.max(K,p):f.y1+X+W),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),K=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-T-e-K),c[g].lineCoordinates={x1:l-S,y1:h,x2:m-S,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(A[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(A[g]+S),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),S+=A[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),K=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+X+W<Math.max(K,p)?Math.max(K,p):f.y1+X+W),K=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+K)),b[g].lineCoordinates=
{x1:l+U,y1:h,x2:l+U,y2:k,height:Math.abs(k-h)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(y[g]-(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0))-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:h,x2:m+(y[g]+U),y2:k,width:m-l,height:k-h},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
...
a[g].valueType?2:1)].position,l=a[g].getApparentDifference(a[g].viewportMinimum,l),E=a[g].logarithmic?(1<l?Math.log(l)/a[g].conversionParameters.lnLogarithmBase*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1:(0<l?l*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1));if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateValueToPixelConversionParameters(),d[g].calculateBreaksSizeInValues(),d[g]._labels&&1<d[g]._labels.length&&(D=(d[g].logarithmic?
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[v-1][g]===M[v][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)I=N[v-1][g]===N[v][g]?!0:!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[v-1][g]===O[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=Q[v-
...
[];D=[];F=[];w=[];E=[];u=[];M=[];for(N=[];4>v;){T=U=V=S=Z=K=W=e=Q=O=G=X=0;if(a&&0<a.length)for(F=[],g=U=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),U+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));M.push(F);if(d&&0<d.length)for(w=[],g=T=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),T+=w[g],W+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));N.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-T-W>n.width-10?n.width-10:f.x2-T-W),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-z/2:0===c[g].labelAngle?m-z/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!s(A)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,A):0===b[g].labelAngle?Math.max(l,A/2):l),0<!d.length&&(m-=y/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
b[0].createLabelsAndCalculateHeight():0));u.push(D);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(k=c[g]._labels[0],h=c[g]._labels[c[g]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),z=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));
...
Math.max(K,10)?Math.max(K,10):f.y1):f.y1<Math.max(K,10)?Math.max(K,10):f.y1;m=Math.round(f.x2-T-W);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-S>n.height-Math.max(K,10)?n.height-Math.max(K,10):f.y2-S):f.y2>n.height-Math.max(K,10)?n.height-Math.max(K,10):f.y2;if(c&&0<c.length)for(K=0;K<c.length;K++)c[K]&&c[K].labelAutoFit&&(m=0>c[K].labelAngle?Math.max(m,x):0===c[K].labelAngle?Math.max(m,x/2):m,l=0>c[K].labelAngle||0===c[K].labelAngle?m-T:l);if(b&&0<b.length)for(K=0;K<b.length;K++)b[K]&&
b[K].labelAutoFit&&(m=b[K].lineCoordinates.x2,l=m-T);d[g].lineCoordinates={x1:m+Q,y1:h,x2:m+Q,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(w[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:m+w[g]+Q,y2:k,width:m-l,height:k-h};d[g].title&&(d[g]._titleTextBlock.maxWidth=
...
!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=E[v-1][g]===E[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=u[v-1][g]===u[v][g]?!0:!1;else L=!0}if(r&&I&&J&&L)break;v++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;Q(this.id);var f,h,m,s,k,n;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(N(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,h=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,m=this.chart.plotArea.y2+
p/2+0.5<<0):(e=this.chart.plotArea.y2,m=this.chart.plotArea.y1-p/2+0.5<<0,a*=-1),this.bounds={x1:b-p/2,y1:e,x2:h+p/2,y2:m},this.ctx.moveTo(b,e),"straight"===this.type||"top"===this.scaleBreaks.parent._position&&0>=a||"bottom"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(b,m),this.ctx.lineTo(h,m),this.ctx.lineTo(h,e);else if("wavy"===this.type){s=b;k=e;f=0.5;n=(m-k)/a/3;for(var q=0;q<n;q++)this.ctx.bezierCurveTo(s+f*a,k+a,s+f*a,k+2*a,s,k+3*a),k+=3*a,f*=-1;this.ctx.bezierCurveTo(s+f*a,
k+a,s+f*a,k+2*a,s,k+3*a);s=h;f*=-1;this.ctx.lineTo(s,k);for(q=0;q<n;q++)this.ctx.bezierCurveTo(s+f*a,k-a,s+f*a,k-2*a,s,k-3*a),k-=3*a,f*=-1}else{if("zigzag"===this.type){f=-1;k=e+a;s=b+a;n=(m-k)/a/2;for(q=0;q<n;q++)this.ctx.lineTo(s,k),s+=2*f*a,k+=2*a,f*=-1;this.ctx.lineTo(s,k);s+=h-b;for(q=0;q<n+1;q++)this.ctx.lineTo(s,k),s+=2*f*a,k-=2*a,f*=-1;this.ctx.lineTo(s+f*a,k+a)}}else if("left"===this.scaleBreaks.parent._position||"right"===this.scaleBreaks.parent._position)if(e=1===p%2?(e.y<<0)+0.5:e.y<<
0,m=1===p%2?(b.y<<0)+0.5:b.y<<0,"left"===this.scaleBreaks.parent._position?(b=this.chart.plotArea.x1,h=this.chart.plotArea.x2+p/2+0.5<<0):(b=this.chart.plotArea.x2,h=this.chart.plotArea.x1-p/2+0.5<<0,a*=-1),this.bounds={x1:b,y1:e-p/2,x2:h,y2:m+p/2},this.ctx.moveTo(b,e),"straight"===this.type||"left"===this.scaleBreaks.parent._position&&0>=a||"right"===this.scaleBreaks.parent._position&&0<=a)this.ctx.lineTo(h,e),this.ctx.lineTo(h,m),this.ctx.lineTo(b,m);else if("wavy"===this.type){s=b;k=e;f=0.5;n=
(h-s)/a/3;for(q=0;q<n;q++)this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k),s+=3*a,f*=-1;this.ctx.bezierCurveTo(s+a,k+f*a,s+2*a,k+f*a,s+3*a,k);k=m;f*=-1;this.ctx.lineTo(s,k);for(q=0;q<n;q++)this.ctx.bezierCurveTo(s-a,k+f*a,s-2*a,k+f*a,s-3*a,k),s-=3*a,f*=-1}else if("zigzag"===this.type){f=1;k=e-a;s=b+a;n=(h-s)/a/2;for(q=0;q<n;q++)this.ctx.lineTo(s,k),k+=2*f*a,s+=2*a,f*=-1;this.ctx.lineTo(s,k);k+=m-e;for(q=0;q<n+1;q++)this.ctx.lineTo(s,k),k+=2*f*a,s-=2*a,f*=-1;this.ctx.lineTo(s+a,k+f*a)}0<p&&this.ctx.stroke();
...
n.push(w));w=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var w=Math.abs(a-this.parent.convertValueToPixel(n[y].dataPoint.y[0])),u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else u=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<w&&(w=u,y=r);else if("stackedBar"===n[0].dataSeries.type)for(var w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),z=u=0,r=y=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else z+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(z)),u<w&&(w=u,y=r);else if("stackedBar100"===n[0].dataSeries.type)for(var w=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),A=z=u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else z+=n[r].dataPoint.y,A=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,A=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[A]),u=Math.abs(a-this.parent.convertValueToPixel(A)),u<w&&(w=u,y=r);else for(w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=y=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<w&&(w=u,y=r);B=n[y];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[y].type||"error"===this.parent.dataSeries[y].type){w=Math.abs(a-this.parent.convertValueToPixel(B.dataPoint.y[0]));
for(r=u=0;r<B.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(B.dataPoint.y[r])),u<w&&(w=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(B.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(B.dataPoint.y[b])<<0;this.value=B.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:B.dataPoint.y[b]}):s(this.options.label)?da(s(c)?B.dataPoint.y[b]:c,this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[y].type){w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=u=0;for(r=y;0<=r;r--)z+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(z)),u<w&&(w=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:B.dataPoint.y}):s(this.options.label)?
da(s(c)?B.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[y].type){w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));A=z=u=0;for(r=y;0<=r;r--)z+=n[r].dataPoint.y,A=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,A=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[A]),u=Math.abs(a-this.parent.convertValueToPixel(A)),u<w&&(w=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:
this.parent.convertValueToPixel(A)<<0;this.value=A;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:A}):s(this.options.label)?da(s(c)?A:c,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(B.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(B.dataPoint.y)<<0,this.value=B.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,
crosshair:this.options,value:B.dataPoint.y}):s(this.options.label)?da(s(c)?B.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/
...
this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=w.index&&(w.dataSeries=this.parent.dataSeries[y],null!==w.dataPoint.y&&w.dataSeries.visible&&n.push(w));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});B=n[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(B.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(B.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};A=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
...
"boxAndWhisker"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<w&&(w=u,y=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=z=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else z+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(z)),u<w&&(w=u,y=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=A=z=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=
0;B<n[r].dataPoint.y.length;B++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else z+=n[r].dataPoint.y,A=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,A=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[A]),u=Math.abs(d-this.parent.convertValueToPixel(A)),u<w&&(w=u,y=r);else for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(B=0;B<n[r].dataPoint.y.length;B++)u=
Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[B])),u<w&&(w=u,y=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<w&&(w=u,y=r);B=n[y];b=0;if("rangeColumn"===this.parent.dataSeries[y].type||"rangeArea"===this.parent.dataSeries[y].type||"error"===this.parent.dataSeries[y].type||"rangeSplineArea"===this.parent.dataSeries[y].type||"candlestick"===this.parent.dataSeries[y].type||"ohlc"===this.parent.dataSeries[y].type||"boxAndWhisker"===this.parent.dataSeries[y].type){w=
Math.abs(d-this.parent.convertValueToPixel(B.dataPoint.y[0]));for(r=u=0;r<B.dataPoint.y.length;r++)u=Math.abs(d-this.parent.convertValueToPixel(B.dataPoint.y[r])),u<w&&(w=u,b=r);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(B.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(B.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:B.dataPoint.y[b]}):s(this.options.label)?da(s(c)?B.dataPoint.y[b]:c,this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=B.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[y].type||"stackedArea"===this.parent.dataSeries[y].type){w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=u=0;for(r=y;0<=r;r--)z+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(z)),u<w&&(w=u,b=r);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:B.dataPoint.y}):s(this.options.label)?da(s(c)?B.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else if("stackedColumn100"===this.parent.dataSeries[y].type||"stackedArea100"===this.parent.dataSeries[y].type){w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));z=u=0;for(r=y;0<=r;r--)z+=n[r].dataPoint.y,A=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,A=100*(z/n[r].dataSeries.plotUnit.dataPointYSums[A]),
u=Math.abs(d-this.parent.convertValueToPixel(A)),u<w&&(w=u,b=r);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:this.parent.convertValueToPixel(A)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:A}):s(this.options.label)?da(s(c)?A:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=A}else"waterfall"===this.parent.dataSeries[y].type?(v=1===q.lineWidth%2?(this.parent.convertValueToPixel(B.dataSeries.dataPointEOs[B.index].cumulativeSum)<<
...
y.version="v3.7.7 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
...
*/
document.createElement("div").getContext||function(){function V(){return this.context_||(this.context_=new C(this))}function W(a,b,c){var g=M.call(arguments,2);return function(){return a.apply(b,g.concat(M.call(arguments)))}}function N(a){return String(a).replace(/&/g,"&amp;").replace(/"/g,"&quot;")}function O(a){a.namespaces.g_vml_||a.namespaces.add("g_vml_","urn:schemas-microsoft-com:vml","#default#VML");a.namespaces.g_o_||a.namespaces.add("g_o_","urn:schemas-microsoft-com:office:office","#default#VML");
...
function A(a){this.code=this[a];this.message=a+": DOM Exception "+this.code}var x=Math,k=x.round,J=x.sin,K=x.cos,ba=x.abs,aa=x.sqrt,q=10,r=q/2;navigator.userAgent.match(/MSIE ([\d.]+)?/);var M=Array.prototype.slice;O(document);var U={init:function(a){a=a||document;a.createElement("div");a.attachEvent("onreadystatechange",W(this.init_,this,a))},init_:function(a){a=a.getElementsByTagName("canvas");for(var b=0;b<a.length;b++)this.initElement(a[b])},initElement:function(a){if(!a.getContext){a.getContext=
...
10,"px;height:",10,"px;position:relative;");if(1!=this.m_[0][0]||this.m_[0][1]||1!=this.m_[1][1]||this.m_[1][0]){var t=[];t.push("M11=",this.m_[0][0],",","M12=",this.m_[1][0],",","M21=",this.m_[0][1],",","M22=",this.m_[1][1],",","Dx=",k(m.x/q),",","Dy=",k(m.y/q),"");var v=s(this,c+e,g),w=s(this,c,g+d);c=s(this,c+e,g+d);m.x=x.max(m.x,v.x,w.x,c.x);m.y=x.max(m.y,v.y,w.y,c.y);p.push("padding:0 ",k(m.x/q),"px ",k(m.y/q),"px 0;filter:progid:DXImageTransform.Microsoft.Matrix(",t.join(""),", sizingmethod='clip');")}else p.push("top:",
k(m.y/q),"px;left:",k(m.x/q),"px;");p.push(' ">','<g_vml_:image src="',a.src,'"',' style="width:',q*e,"px;"," height:",q*d,'px"',' cropleft="',r/l,'"',' croptop="',y/u,'"',' cropright="',(l-r-n)/l,'"',' cropbottom="',(u-y-h)/u,'"'," />","</g_vml_:group>");this.element_.insertAdjacentHTML("BeforeEnd",p.join(""))};d.stroke=function(a){var b=[];b.push("<g_vml_:shape",' filled="',!!a,'"',' style="position:relative;width:',10,"px;height:",10,'px;"',' coordorigin="0,0"',' coordsize="',10*q,",",10*q,'"',
...
"left";break;default:l="left"}switch(this.textBaseline){case "hanging":case "top":t=h.size/1.75;break;case "middle":break;default:case null:case "alphabetic":case "ideographic":case "bottom":t=-h.size/2.25}switch(l){case "right":d=1E3;r=0.05;break;case "center":d=r=500}b=s(this,b+0,c+t);n.push('<g_vml_:line from="',-d,' 0" to="',r,' 0.05" ',' coordsize="100 100" coordorigin="0 0"',' filled="',!e,'" stroked="',!!e,'" style="position:relative;width:1px;height:1px;">');e?S(this,n):T(this,n,{x:-d,y:0},
{x:r,y:h.size});e=f[0][0].toFixed(3)+","+f[1][0].toFixed(3)+","+f[0][1].toFixed(3)+","+f[1][1].toFixed(3)+",0,0";b=k(b.x/q)+","+k(b.y/q);n.push('<g_vml_:skew on="t" matrix="',e,'" ',' offset="',b,'" origin="',d,' 0" />','<g_vml_:path textpathok="true" />','<g_vml_:textpath on="true" string="',N(a),'" style="v-text-align:',l,";font:",N(p),'" /></g_vml_:line>');this.element_.insertAdjacentHTML("beforeEnd",n.join(""))};d.fillText=function(a,b,c,d){this.drawText_(a,b,c,d,!1)};d.strokeText=function(a,
b,c,d){this.drawText_(a,b,c,d,!0)};d.measureText=function(a){this.textMeasureEl_||(this.element_.insertAdjacentHTML("beforeEnd",'<span style="position:relative;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;"></span>'),this.textMeasureEl_=this.element_.lastChild);var b=this.element_.ownerDocument;this.textMeasureEl_.innerHTML="";this.textMeasureEl_.style.font=this.font;this.textMeasureEl_.appendChild(b.createTextNode(a));return{width:this.textMeasureEl_.offsetWidth}};d.clip=function(){};
